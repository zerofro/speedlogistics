(function ($) {
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        this.$body.find('> tr[data-sys] > td').off('click dblclick').on('click dblclick', function (e) {
            var $td = $(this),
                $tr = $td.parent(),
        ...
        this.$body.find('> tr[data-sys] > td > .detail-icon').off('click').on('click', function () {
            debugger;
            var $this = $(this),
        ...
        this.$body.find('> tr[data-sys] > td > .tree-icon').off('click').on('click', function (e) {
            debugger;
            e.stopPropagation();
            var $this = $(this),
                $tr = $this.parent().parent(),
